...
mod parser_ffi {
    ...
    extern "Rust" {
        ...
        #[cxx_name = "eval"]
        fn ffi_eval(&self, cmd: &CxxWString, io: &IoChain) -> i32;
        #[cxx_name = "eval_with"]
        fn ffi_eval_with(
            &self,
            cmd: &CxxWString,
        ...
        fn ffi_current_line(&self) -> UniquePtr<CxxWString>;
        #[cxx_name = "get_lineno"]
        fn ffi_get_lineno(&self) -> i32;
        #[cxx_name = "is_block"]
        ...
        #[cxx_name = "set_syncs_uvars"]
        fn ffi_set_syncs_uvars(&self, flag: bool);
        #[cxx_name = "emit_profiling"]
        fn ffi_emit_profiling(&self, s: &CxxString);
        #[cxx_name = "clear_profiling"]
        fn ffi_clear_profiling(&self);
        #[cxx_name = "vars"]
...
impl Parser {
    ...
    pub fn ffi_eval(&self, cmd: &CxxWString, io: &IoChain) -> i32 {
        todo!()
    }
    fn ffi_eval_with(
        &self,
    ...
    fn ffi_set_syncs_uvars(&self, flag: bool) {
        self.set_syncs_uvars(flag)
    }
    fn ffi_set_last_statuses(&self) {
        todo!()
    }
    fn ffi_emit_profiling(&self, s: &CxxString) {
        self.emit_profiling(s.as_bytes())
    }
    fn ffi_clear_profiling(&self) {
